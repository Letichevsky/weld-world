    ...
    <div className='w-full'>
        ...
        <div className="w-full max-w-[70svw] mx-auto flex relative">
          <div className="bg-[#f7f7f7] w-[360px] min-w-[360px] p-8 flex flex-col gap-6 absolute z-10">
            ...
            <p className="text-[#696969]">Veld World was founded on December 9, 
              2005 in the UK, starting its activity as a supplier of high-quality 
              grocery group of goods. Canned pineapples and other fruits Tropic Life 
              Dream Valley, olives and olives Diva Oliva and Dream Valley, 
              as well as olive oil Diva Oliva - have already become loved by a huge 
              number of con-sumers. Every day we try to develop the markets 
              of Europe and Asia as much as possible. Striving to satisfy the taste 
      ...
      <div className="w-full bg-[#18713b] pl-[50%]">
        <div className="h-full max-w-[650px] bg-[#0f4b27] py-6 px-16">
          <p className='text-white'>We constantly strive to ensure the highest quality 
          of our products and maintain a high professional level of our services so that you can enjoy truly 
          delicious and high-quality products that you love so much. Veld World is maximally focused on satisfying the needs 
          of its customers. We are always ready for cooperation and devel-opment, 
          promptly responding to changes in the market situation.</p>
        </div>
      </div>
    </div>
  )
